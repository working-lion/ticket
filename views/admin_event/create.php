...
<div class="container">
    ...
    <?php if ($result): ?>
        <p class="ok_message"><i class="fa fa-check-square-o" aria-hidden="true"></i>Концерт успешно добавлен!</p>
    <?php else: ?>
        ...
        <?php endif; ?>
        <h2>Страница добавления концерта</h2>
    ...
    <form action="" method="post" class="middle_form" enctype="multipart/form-data">
        ...
        <input type="submit" name="event_create" value="Добавить концерт"class="btn blue_btn right">
    </form>
    <?php endif; ?>
</div>
